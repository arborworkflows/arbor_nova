...
export default {
  ...
  data: () => ({
    ...
    samples: [
      ...
      {   
        label: 'PhyloSignal',
        image: require('../assets/phylosignal_app.png'),
        route: 'phylosignal',
        description: 'Search for Phylogenetic Signal, given a tree and a matrix.' 
      },    
      {   
        label: 'FitDiscrete',
        image: require('../assets/fitDiscrete_app.png'),
        route: 'fitdiscrete',
        description: 'Fit a model to discrete character values',
      },    
      {   
        label: 'FitContinuous',
