...
def infer_rhabdo(self,image_file,**kwargs):
    ...
    path = '/home/ubuntu/arbor_nova/girder_worker_tasks/arbor_nova_tasks/arbor_tasks/fnlcr/'
    ...
    predict_image = (predict_image.squeeze().cpu().numpy().round())
    predict_image = (predict_image*256.0)
